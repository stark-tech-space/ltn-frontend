...
export interface IIncomeStatements {
  date: string;
  symbol: string;
...
export interface IStockTableRes extends ILtnApiCommonData {
  list: Array<IStockTableInfo>;
}

export interface IStockTableInfo {
  id: string;
  securityCode: string;
  year: string;
  quarter: string;
...
export interface IStockTable {
  name: string;
  data: Array<IStockTableData>;
}

export interface IStockTableData {
  date: string;
  code: string;
  name: string;
  value: string;
